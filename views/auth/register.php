...
<div style="min-height:100vh;display:grid;grid-template-columns:1fr 1fr;" class="max-lg:block">
    ...
    <!-- ====== RIGHT PANEL (form) ====== -->
    <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;padding:48px 24px;background:#fff;overflow-y:auto;">

        <!-- Mobile logo -->
        <a href="<?= BASE_URL ?>" style="display:flex;align-items:center;gap:9px;text-decoration:none;margin-bottom:32px;" class="lg:hidden">
